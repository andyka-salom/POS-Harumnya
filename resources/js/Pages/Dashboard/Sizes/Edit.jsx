...
export default function Edit({ size }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("sizes.update", size.id), {
            onSuccess: () => toast.success("Ukuran berhasil diperbarui! 🚀"),
    ...
    return (
        <>
            <Head title={`Edit Ukuran: ${size.name}`} />
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Edit Ukuran</h1>
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Perbarui informasi ukuran produk</p>
                        </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row justify-end gap-3">
                        ...
                        >
                            ...
                            <span>{processing ? "Menyimpan..." : "Update Ukuran"}</span>
                        </button>
                    </div>
                </form>
            </div>

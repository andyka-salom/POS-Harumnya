...
export default function Create({ types }) {
    ...
    const submit = (e) => {
        ...
        post(route("payment-methods.store"), {
            onSuccess: () => toast.success("Metode pembayaran berhasil ditambahkan."),
        ...
        <>
            ...
            <div className="max-w-3xl mx-auto py-4">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold dark:text-white">Metode Pembayaran Baru</h1>
                        <p className="text-sm text-slate-500">Tambahkan metode pembayaran yang diterima di toko.</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    >
                        ...
                        {processing ? "Menyimpan..." : "Simpan Metode Pembayaran"}
                    </button>
                </form>
            </div>
        </>

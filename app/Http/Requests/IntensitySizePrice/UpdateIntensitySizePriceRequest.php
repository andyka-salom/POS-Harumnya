...
class UpdateIntensitySizePriceRequest extends FormRequest
{
    ...
    /**
     * Validasi kombinasi intensity+size unik, kecuali record dirinya sendiri.
     */
    public function withValidator($validator): void
    {
        $validator->after(function ($v) {
            ...
            /** @var IntensitySizePrice $current */
            $current = $this->route('intensity_size_price');

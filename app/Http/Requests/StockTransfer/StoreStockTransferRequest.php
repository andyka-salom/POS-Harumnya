...
class StoreStockTransferRequest extends FormRequest
{
    ...
    {
        return [
            'from_location_type.required' => 'Lokasi asal wajib dipilih',
            'from_location_id.required' => 'Lokasi asal wajib dipilih',
            'to_location_type.required' => 'Lokasi tujuan wajib dipilih',
            ...
            'items.*.quantity_requested.required' => 'Kuantitas wajib diisi',
